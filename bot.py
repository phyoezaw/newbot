...
token = '7523716205:AAFy6AN4WhBZ6ek2Qh2elBeDDuRRjp26b60'
bot = telebot.TeleBot(token, parse_mode="HTML")
subscriber = '5827732412'


@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '5827732412':
		bot.reply_to(
		    message,
		    "FUCK!!! You are not Authorize. This Bot is MadeBy  @aung1337"
		)
		return
